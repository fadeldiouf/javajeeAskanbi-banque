		...
		<div class="main">
			<section class="content-header">
				<div class="container-fluide">
					<form method="POST" action="<%=request.getContextPath()%>/templates/viewAgent/" class="signup-form">
						<div class="row md-2">
							<div class="col-md-6">
								<div class="card card-primary">
									<div class="card-header">
										<h3 class="card-title">Info agent</h3>
									</div>
									<div class="card-body">
										<div class="form-group">
											<div class="input-group mb-2">
												...
												<input type="text" class="form-control"
													value="${model.agent.nom}"  name="nom">
											...
											<div class="input-group date" id="reservationdate"
												...
												<input type="text" class="form-control datetimepicker-input"
													data-target="#reservationdate"
													 name="datenaissance"
													value="${model.agent.datenaissance}" />
								...
								<div class="card card-primary">
									...
									<div class="card-body">
										...
										<div class="form-group">
											<div class="input-group mb-3">
												...
												<input type="email" class="form-control" 
													name="email" value="${model.agent.email}">
											</div>
										</div>
										<div class="row">
											<div class="col-sm-6">
										...
										<div class="form-group">
											<div class="input-group">
												<div class="input-group-append">
													<span class="input-group-text">Cni</span>
												</div>
												<input type="text" class="form-control" 
													name="cni" value="${model.agent.cni}">
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input type="text" class="form-control" 
													name="idagent" value="${model.agent.idagent}" readonly>
                                            </div>
											</div>
										</div>
                                    </div>
						...
						<button type="submit" class="btn btn-primary" value="modif" name="action">Valider</button>
					</form>
				</div>
			</section>
		</div>
