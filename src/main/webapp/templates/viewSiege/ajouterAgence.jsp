						                  ...
						                  <div class="card-body">
							                  ...
							                  <div class="form-group">
							                    <div class="input-group mb-2">
									             ...
									             <input type="text" class="form-control" placeholder="Nom de l'agence" name="nomagence">
							                  ...
							                  <div class="form-group">
							                    ...
							                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
							                        ...
							                        <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate" placeholder=" Date de creation" name="datecreation" />
