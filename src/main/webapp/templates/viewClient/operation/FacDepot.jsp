...
<p><span class="offset-2"> Titulaire du compte:&nbsp; &#160;<%= facsession.getAttribute("prenomCl") %> <%= facsession.getAttribute("nomCl") %></span></p>
<div class="row ml-4">
<div class="col-md-6">
...
%>
 <p><span class="offset-2"> Type D'operation: &nbsp; &#160; Depot</span></p>
 <p> <span class="offset-2">Numero de Compte:&nbsp; &#160;Depot</span></p>
 <p><span class="offset-2"> Date:&nbsp; &#160;<% out.print(  ft.format(dNow) ); %></span></p>
 <p><span class="offset-2"> Heure:&nbsp; &#160;<% out.print(  ft1.format(dNow) ); %></span></p>
 <p><span class="offset-2"> Agence:&nbsp; &#160;Depot</span></p>
 <p><span class="offset-2"> Responsable de l'operation:&nbsp; &#160;Depot</span></p>
 <p><span class="offset-2"> Montant:&nbsp; &#160;Depot</span></p>
 <p><span class="offset-2"> Titulaire du compte:&nbsp; &#160;Depot</span></p>
 <div class="row ml-4">
 <div class="col-md-6">
 <div class="card" style="width: 18rem; height: 7rem;">
  <div class="card-body">
